...
PG_KEYWORD("analyze", ANALYZE, RESERVED_KEYWORD, BARE_LABEL)		/* American spelling */
...
PG_KEYWORD("kayvee", KAYVEE, RESERVED_KEYWORD, BARE_LABEL)
...
PG_KEYWORD("temporali", TEMPORAL, RESERVED_KEYWORD, BARE_LABEL)
